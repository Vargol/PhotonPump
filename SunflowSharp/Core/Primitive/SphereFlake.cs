...
{
	public class SphereFlake : PrimitiveList {
		private static int MAX_LEVEL = 20;
		private static float[] boundingRadiusOffset = new float[MAX_LEVEL + 1];
		private static float[] recursivePattern = new float[9 * 3];
		private int level = 2;
